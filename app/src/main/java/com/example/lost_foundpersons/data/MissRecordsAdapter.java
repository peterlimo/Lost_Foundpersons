...
public class MissRecordsAdapter extends RecyclerView.Adapter<MissRecordsAdapter.ViewHolder> {
    private List<GetMiss> UserList;
    private Context context;
    OnItemClickListener listener;
    public MissRecordsAdapter(List<GetMiss>UserList,Context context,OnItemClickListener listener){
    ...
    @Override
    public void onBindViewHolder(@NonNull MissRecordsAdapter.ViewHolder holder, int position) {
